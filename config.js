...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://files.catbox.moe/nyyd0g.mp4";
...
global.userImages = process.env.USER_IMAGES || "https://files.catbox.moe/nyyd0g.mp4";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "`kylieXcyleeTech©™`👸❤️🧸",
